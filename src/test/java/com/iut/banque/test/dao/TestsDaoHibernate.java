...
public class TestsDaoHibernate {
    ...
    @Test
    public void testIsUserAllowedWithEmptyUserIdOrPwd() {
        boolean result = daoHibernate.isUserAllowed("", "motDePasse");
        assertFalse(result);
    }

    @Test
    public void testIsUserAllowedWithNonExistingUser() {
        boolean result = daoHibernate.isUserAllowed("utilisateurInexistant", "motDePasse");
        assertFalse(result);
    }
    ...
    public void testIsUserAllowedWithIncorrectPassword() {
        String validUserId = "utilisateurValide";
        String incorrectUserPwd = "motDePasseIncorrect";
